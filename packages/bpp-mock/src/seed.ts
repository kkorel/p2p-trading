/**
 * Seed data for BPP Mock
 * Creates: 2 providers, 1 solar item, 2 offers with different time windows and trust scores
 */
...
async function seed() {
  console.log('🌱 Seeding BPP Mock database...\n');
